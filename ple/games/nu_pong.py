...
class nu_pong(PyGameWrapper):
    """
    Loosely based on code from marti1125's `nu_pong game`_.

    .. _nu_pong game: https://github.com/marti1125/nu_pong/
...
if __name__ == "__main__":
    ...
    pygame.init()
    game = nu_pong(width=256, height=200)
