...
class nu_pong_2(PyGameWrapper):
    """
    Loosely based on code from marti1125's `nu_pong_2 game`_.

    .. _nu_pong_2 game: https://github.com/marti1125/nu_pong_2/
    ...
    def __init__(self, width=256, height=48, MAX_SCORE=11):
        ...
        self.paddle_one_location = 4 + (width - 64) // 2
        self.paddle_two_location = self.paddle_one_location + 56 #= percent_round_int(width, 0.0625)
        #self.paddle_dist_to_wall = 100
        #self.paddle_distance_to_wall = (width - 64) + 4
    ...
    def game_over(self):
        # nu_pong_2 used 11 as max score
    ...
    def init(self):
        ...
        self.agentPlayer = Player(
            ...
            self.paddle_width,
            self.paddle_height,
            (self.paddle_one_location, self.height / 2),
            self.width,
            self.height)
        ...
        self.cpuPlayer = Player(
            ...
            self.paddle_width,
            self.paddle_height,
            (self.paddle_two_location, self.height / 2),
            self.width,
            self.height)
    ...
    def _reset_ball(self, direction):
        self.ball.pos.x = self.paddle_one_location + 56//2  # move it to the center
...
if __name__ == "__main__":
    ...
    pygame.init()
    game = nu_pong_2(width=256, height=200)
